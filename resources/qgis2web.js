...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-11908350.053654, 3647481.291579, -11817605.088081, 3736045.129801], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11908350.053654, 3647481.291579, -11817605.088081, 3736045.129801],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-11908350.053654, 3647481.291579, -11817605.088081, 3736045.129801], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">mapa de ganador por seccion,ayuntamiento juarez 2024</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (31 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'informacio a describir del mapa';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_seccionesconganadorayunganador_por_seccion_2,
    colName: 'SECCION',
    zoom: 10,
    collapsed: true,
    map: map,
